            ...
            <div className="container d-block box-shadow">
                <div className='form-header-content px-0 py-3 pt-2'>
                    <div className='d-flex'>
                        <button type="button" className="button cancel box-shadow" onClick={() => navigate('/list-vendor')}>
                    ...
                    <div className='d-flex'>
                        <button type="button" className="button preview box-shadow" onClick={previewVendor}>
                            <i className="fa-solid fa-circle-info px-2"></i>Preview
                        </button>
                        <div className='px-3 pe-0'>
                            <button type="button" className="button add box-shadow px-4" onClick={saveVendor}>
