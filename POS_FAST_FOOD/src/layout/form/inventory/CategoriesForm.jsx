        ...
        return (
            <div className='form-header-content px-0 py-3 pt-2'>
                <div className='d-flex'>
                    <button type="button" class="button cancel box-shadow " onClick={() => navigate('/list-category')}><IoIosArrowBack /><span className='px-2'>Cancel</span> </button>
                ...
                <div className='d-flex'>
                    ...
                    <div className='px-3 pe-0'>
                        <button type="button" class="button add box-shadow px-4" onClick={saveCategories}><IoSaveSharp /><span className='px-2'>Save</span> </button>
                    </div>
                </div>
