        ...
        if (findCompanyName) {
            return (
                <>
                    ...
                    address 1 : {findCompanyName.addressLine1}<br />
                    address 2 : {findCompanyName.addressLine2}
                            ...
                            <form className="d-flex h-100" >
                                <div className='start w-50 p-2'>
                                    <div className='w-100 px-4'>
                                        ...
                                        <div className="fs-6 text-secondary">{employeeData.positionID} softwere engineer</div>
                                    </div>
                                </div>
                        ...
                        <div className="d-flex">
                            <div className='d-block text-start fs-6 bg-white px-4 py-2 w-50'>
                                ...
                                <div className='group-input center w-100 py-1' style={{ fontSize: 16 }}>
                                    ...
                                    <p className='w-75 text-start'>{getManagerName(employeeData.managerID)}</p>
                                </div>
                                <div className='group-input center w-100 py-1' style={{ fontSize: 16 }}>
                        ...
                        <div className='bg-white py-3'>
                            <ul className="nav nav-tabs" id="myTab" role="tablist">
                                <li className="nav-item" role="presentation">
                                    <button className="text-dark nav-link  border-bottom active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Resume</button>
                                </li>
                                <li className="nav-item" role="presentation">
                            ...
                            <div class="tab-content border-0" id="myTabContent">
                                <div class="border-0 tab-pane show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                    <textarea name="" id="" className='w-100 border p-3' value={employeeData.resume}></textarea>
                                </div>
